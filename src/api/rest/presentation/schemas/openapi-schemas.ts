/**
 * OpenAPI schema definitions for route documentation
...
export const forbiddenResponseSchema = {
  ...
  properties: {
    error: {
      type: 'object',
      properties: {
        type: { type: 'string', example: 'AuthorizationError' },
...
export const passwordlessTag = ['Passwordless'];
export const oauthTag = ['OAuth'];
export const sessionsTag = ['Sessions'];
export const devicesTag = ['Devices'];
export const usersTag = ['Users'];
export const adminTag = ['Admin'];
export const webhooksTag = ['Webhooks'];
export const monitoringTag = ['Monitoring'];
